...
Cette phase a permis : (1) une exploration exhaustive des solutions GPU (Modal, Colab, Kaggle, Hugging Face, NVIDIA NIM), (2) le développement et l'affinement d'indicateurs EQ basés sur des métriques comportementales, (3) une comparaison systématique entre approche par métriques observables et modèles de deep learning pour l'analyse émotionnelle.
